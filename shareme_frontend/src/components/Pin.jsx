...
const Pin = ({ pin: { postedBy, image, _id, destination, save }}) => { 
    ...
    <div className='m-2'>
        ...
        >
            <img className='rounded-g w-full' alt='user-post' src={urlFor(image).width(250).url()}/>
            {postHovered && (
                <div
                    ...
                    <div className='flex justify-between items-center gap-2 w-full'>
                        {destination && (
                            <a
                                ...
                                target='_blank'
                                rel='noreferrer'
                                className='bg-white flex items-center gap-2 text-black font-bold p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover hover:shadow-md'
                            >
